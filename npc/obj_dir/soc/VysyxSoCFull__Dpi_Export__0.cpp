...
int VysyxSoCFull::get_pc() {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VysyxSoCFull___024root::get_pc\n"); );
    // Init
    ...
    VysyxSoCFull__Vcb_get_pc_t __Vcb = (VysyxSoCFull__Vcb_get_pc_t)(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
    (*__Vcb)((VysyxSoCFull__Syms*)(__Vscopep->symsp()), get_pc__Vfuncrtn__Vcvt);
...
int VysyxSoCFull::get_inst() {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VysyxSoCFull___024root::get_inst\n"); );
    // Init
    ...
    const VerilatedScope* __Vscopep = Verilated::dpiScope();
    VysyxSoCFull__Vcb_get_inst_t __Vcb = (VysyxSoCFull__Vcb_get_inst_t)(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
    (*__Vcb)((VysyxSoCFull__Syms*)(__Vscopep->symsp()), get_inst__Vfuncrtn__Vcvt);
...
int VysyxSoCFull::get_difftest_valid() {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VysyxSoCFull___024root::get_difftest_valid\n"); );
    // Init
    ...
    const VerilatedScope* __Vscopep = Verilated::dpiScope();
    VysyxSoCFull__Vcb_get_difftest_valid_t __Vcb = (VysyxSoCFull__Vcb_get_difftest_valid_t)(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
    (*__Vcb)((VysyxSoCFull__Syms*)(__Vscopep->symsp()), get_difftest_valid__Vfuncrtn__Vcvt);
...
int VysyxSoCFull::get_non_inst() {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VysyxSoCFull___024root::get_non_inst\n"); );
    // Init
    ...
    const VerilatedScope* __Vscopep = Verilated::dpiScope();
    VysyxSoCFull__Vcb_get_non_inst_t __Vcb = (VysyxSoCFull__Vcb_get_non_inst_t)(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
    (*__Vcb)((VysyxSoCFull__Syms*)(__Vscopep->symsp()), get_non_inst__Vfuncrtn__Vcvt);
...
int VysyxSoCFull::get_dcache_hit_count() {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VysyxSoCFull___024root::get_dcache_hit_count\n"); );
    // Init
    ...
    const VerilatedScope* __Vscopep = Verilated::dpiScope();
    VysyxSoCFull__Vcb_get_dcache_hit_count_t __Vcb = (VysyxSoCFull__Vcb_get_dcache_hit_count_t)(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
    (*__Vcb)((VysyxSoCFull__Syms*)(__Vscopep->symsp()), get_dcache_hit_count__Vfuncrtn__Vcvt);
...
int VysyxSoCFull::get_dcache_miss_count() {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VysyxSoCFull___024root::get_dcache_miss_count\n"); );
    // Init
    ...
    const VerilatedScope* __Vscopep = Verilated::dpiScope();
    VysyxSoCFull__Vcb_get_dcache_miss_count_t __Vcb = (VysyxSoCFull__Vcb_get_dcache_miss_count_t)(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
    (*__Vcb)((VysyxSoCFull__Syms*)(__Vscopep->symsp()), get_dcache_miss_count__Vfuncrtn__Vcvt);
...
int VysyxSoCFull::get_i_cnt() {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VysyxSoCFull___024root::get_i_cnt\n"); );
    // Init
    ...
    const VerilatedScope* __Vscopep = Verilated::dpiScope();
    VysyxSoCFull__Vcb_get_i_cnt_t __Vcb = (VysyxSoCFull__Vcb_get_i_cnt_t)(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
    (*__Vcb)((VysyxSoCFull__Syms*)(__Vscopep->symsp()), get_i_cnt__Vfuncrtn__Vcvt);
...
int VysyxSoCFull::get_d_cnt() {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VysyxSoCFull___024root::get_d_cnt\n"); );
    // Init
    ...
    const VerilatedScope* __Vscopep = Verilated::dpiScope();
    VysyxSoCFull__Vcb_get_d_cnt_t __Vcb = (VysyxSoCFull__Vcb_get_d_cnt_t)(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
    (*__Vcb)((VysyxSoCFull__Syms*)(__Vscopep->symsp()), get_d_cnt__Vfuncrtn__Vcvt);
...
int VysyxSoCFull::get_stall_cnt() {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VysyxSoCFull___024root::get_stall_cnt\n"); );
    // Init
    ...
    const VerilatedScope* __Vscopep = Verilated::dpiScope();
    VysyxSoCFull__Vcb_get_stall_cnt_t __Vcb = (VysyxSoCFull__Vcb_get_stall_cnt_t)(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
    (*__Vcb)((VysyxSoCFull__Syms*)(__Vscopep->symsp()), get_stall_cnt__Vfuncrtn__Vcvt);
...
int VysyxSoCFull::get_flush_cnt() {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VysyxSoCFull___024root::get_flush_cnt\n"); );
    // Init
    ...
    const VerilatedScope* __Vscopep = Verilated::dpiScope();
    VysyxSoCFull__Vcb_get_flush_cnt_t __Vcb = (VysyxSoCFull__Vcb_get_flush_cnt_t)(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
    (*__Vcb)((VysyxSoCFull__Syms*)(__Vscopep->symsp()), get_flush_cnt__Vfuncrtn__Vcvt);
